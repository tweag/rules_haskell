...
def _compilation_defaults(hs, cc, java, posix, dep_info, plugin_dep_info, srcs, module_map, import_dir_map, extra_srcs, user_compile_flags, output_mode, with_profiling, interfaces_dir, objects_dir, my_pkg_id, version, extra_ldflags_file, plugins, non_default_plugins, preprocessors):
...
def compile_binary(
    ...
    Returns:
      struct with the following fields:
        ...
        boot_files: set of Haskell boot files
    """
    c = _compilation_defaults(hs, cc, java, posix, dep_info, plugin_dep_info, srcs, module_map, import_dir_map, extra_srcs, user_compile_flags, "dynamic" if dynamic else "static", with_profiling, interfaces_dir, objects_dir, my_pkg_id = None, version = version, extra_ldflags_file = extra_ldflags_file, plugins = plugins, non_default_plugins = non_default_plugins, preprocessors = preprocessors)
