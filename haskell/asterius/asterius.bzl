...
def _ahc_dist_impl(ctx):
    asterius_toolchain = ctx.toolchains["@rules_haskell//haskell/asterius:asterius-toolchain"]
...
module
  ...
  .then(i => {{
    ...
    command = " && ".join([
        ...
        "tar cf {output_tar} --exclude=./{output_tar} -C {workdir} . -h".format(
...
ahc_dist = rule(
    ...
    toolchains = [
        ...
        "@rules_haskell//haskell/asterius:asterius-toolchain",
