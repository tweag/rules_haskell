...
cc_library(
    ...
    includes = glob(["lib/ghc-*/unix-*/include"], exclude_directories=0),
)

# This is needed for Hazel targets.
cc_library(
    name = "rts-headers",
    hdrs = glob(["lib/ghc-*/include/**/*.h", "lib/include/**/*.h"]),
    includes = glob(["lib/ghc-*/include", "lib/include"], exclude_directories=0),
)
