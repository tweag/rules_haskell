...
stack_snapshot(
    name = "stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit",
    extra_deps = {"zlib": ["@zlib.dev//:zlib" if is_nix_shell else "@zlib.hs//:zlib"]},
    haddock = False,
...
haskell_cabal_binary(
    ...
    srcs = glob(["**"]),
    deps = [
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:hslogger",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:aeson",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:base",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:binary",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:base16-bytestring",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:bytestring",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:containers",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:cryptohash-sha1",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:data-default",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:deepseq",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:directory",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:extra",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:filepath",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:ghc-check",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:ghc-paths",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:ghc",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:gitrev",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:hashable",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:haskell-lsp",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:haskell-lsp-types",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:hie-bios",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:ghcide",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:optparse-applicative",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:shake",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:text",
        "@stackage_ghcide_with_a_very_very_very_very_long_name_to_try_and_exceed_the_macos_mach_o_header_size_limit//:unordered-containers",
    ],
    visibility = ["//visibility:public"],
)
    """,
